...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'constants.CACHE.LANGUAGE' => 'string',
            'constants.CACHE.SETTINGS' => 'string',
            ...
            'filesystems.links.E:\work\BaseCodeLaravel\public\storage' => 'string',
...
'cache.stores.dynamodb.table','cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.prefix','constants.CACHE.LANGUAGE',
'constants.CACHE.SETTINGS','database.default','database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\work\\BaseCodeLaravel\\public\\storage','logging.default','logging.deprecations.channel',
...
'admin.language.search','admin.language.create','admin.language.store','admin.language.show','admin.language.edit',
'admin.language.update','admin.language.delete','language.set-current','admin.language.panel','admin.language.panel.update',
'admin.language.mobile','admin.language.mobile.update','admin.language.web','admin.language.web.update','admin.language.download',
'admin.user.index','admin.user.search','admin.user.create','admin.user.store','admin.user.show',
'admin.user.edit','admin.user.update','admin.user.delete','admin.user.toggleStatus','admin.intro.index',
'admin.intro.search','admin.intro.create','admin.intro.store','admin.intro.show','admin.intro.edit',
'admin.intro.update','admin.intro.delete','admin.intro.toggleStatus','admin.banner.index','admin.banner.create',
'admin.banner.store','admin.banner.show','admin.banner.search','admin.banner.edit','admin.banner.update',
'admin.banner.delete','admin.banner.toggleStatus','admin.generalSetting.viewGeneralSetting','admin.generalSetting.updateGeneralSetting','admin.generalSetting.viewPrivacyAndTerms',
'admin.generalSetting.updatePrivacyAndTerms','admin.category.index','admin.category.search','admin.category.create','admin.category.store',
'admin.category.show','admin.category.showSubCategories','admin.category.edit','admin.category.update','admin.category.delete',
'admin.category.toggleStatus','admin.country.index','admin.country.search','admin.country.create','admin.country.store',
...
'admin.category.subcategories','admin.changePassword.index','admin.city.create','admin.city.edit','admin.city.forms.formInput',
'admin.city.index','admin.city.partials._city_table_body','admin.city.shared.controlBut','admin.city.show','admin.country.create',
'admin.country.edit','admin.country.forms.formInput','admin.country.index','admin.country.partials._country_table_body','admin.country.shared.controlBut',
'admin.country.show','admin.home','admin.intro.create','admin.intro.edit','admin.intro.forms.formInput',
'admin.intro.index','admin.intro.partials._intro_table_body','admin.intro.shared.controlBut','admin.intro.show','admin.language.create',
'admin.language.edit','admin.language.forms.formInput','admin.language.index','admin.language.mobile','admin.language.panel',
'admin.language.partials._language_table_body','admin.language.shared.controlBut','admin.language.show','admin.language.web','admin.setting.PrivacyAndTerms.forms.formInput',
'admin.setting.PrivacyAndTerms.index','admin.setting.generalSetting.forms.formInput','admin.setting.generalSetting.index','admin.setting.socialSetting.forms.formInput','admin.setting.socialSetting.index',
'admin.user.create','admin.user.edit','admin.user.forms.formInput','admin.user.index','admin.user.partials._user_table_body',
'admin.user.shared.controlBut','admin.user.show','auth.login','auth.passwords.confirm','auth.passwords.email',
'auth.passwords.reset','auth.register','auth.verify','components.action-button-lang','components.action-buttons',
'components.status-toggle-button','home','layouts.app','layouts.footer','layouts.footer_script',
'layouts.include','layouts.main','layouts.sidebar','layouts.topbar','layouts.validateMessage.errorMessage',
'layouts.validateMessage.successMessage','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','E:.work.BaseCodeLaravel.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
