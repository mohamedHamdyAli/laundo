...
@section('content')
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        @if (canDo('item.create'))
            <a href="{{ route('admin.item.create') }}" class="btn-add">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @php
                            ...
                            $stackCols = 'minmax(3.8rem,4rem) minmax(9rem,1.3fr) minmax(8rem,1fr) minmax(7rem,auto) minmax(6rem,auto)';
                        @endphp
                        ...
                        <div class="data-stack" id="item-table-body" style="--stack-cols: {{ $stackCols }}">
                            @include('admin.item.partials._item_table_body', ['items' => $items])
                        </div>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            setupAjaxSearch({
                inputSelector: '#itemSearchInput',
                tableBodySelector: '#item-table-body',
