    ...
    <section class="section col-sm-6 col-xs-12">
        <div class="card">
            ...
            <div class="card-content">
                <form method="POST" action="{{ route('change-password.update') }}" data-parsley-validate class="create-form">
                    @csrf
                    <div class="row mt-1">
                        <div class="card-body">
                            ...
                            <div class="form-group position-relative has-icon-right mb-4 mandatory">
                                <input type="password" name="new_password" id="new_password" class="form-control form-control-solid" placeholder="{{ __('New Password') }}"
